...
class WebDriverIOMigration extends _base.default {
  constructor(...args) {
    super(...args);
...
_defineProperty(WebDriverIOMigration, "name", '@percy/webdriverio');

_defineProperty(WebDriverIOMigration, "version", '^2.0.0');
