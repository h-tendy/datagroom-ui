...
class DsViewEdit extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            jiraAgile: null,
            jql: "",
            jiraFieldMapping: '# Jira keys: "key", "summary", "type", "assignee", "severity", "priority", "reporter", "foundInRls", "created", "rrtTargetRls", "targetRls", "status", "feature", "rzFeature", "versions", "parentKey", "parentSummary", "parent", "subtasks", "subtasksDetails", "dependsLinks", "implementLinks", "packageLinks", "relatesLinks", "testLinks", "coversLinks", "defectLinks", "automatesLinks", "updated", "votes", "systemFeature", "labels", "epic", "description", "Story Points", "Sprint Name", "jiraSummary", "fixVersions", "Agile Commit", "duedate", "targetRlsGx", "Assignee Manager", "Dev RCA Comments", "Agile Team", "Phase Bug Found", "Phase Bug Introduced", "Failure Category", "Failure Subcategory", "Improvement Suggestions", "Root Cause or Defect Category", "Resolution", "Resolution Details"\n\n',
            jiraAgileLabel: "",
            jiraAgileBoardId: 0,
            jiraAgileFieldMapping: '# Jira keys: "key", "summary", "type", "assignee", "severity", "priority", "reporter", "foundInRls", "created", "rrtTargetRls", "targetRls", "status", "feature", "rzFeature", "versions", "parentKey", "parentSummary", "parent", "subtasks", "subtasksDetails", "dependsLinks", "implementLinks", "packageLinks", "relatesLinks", "testLinks", "coversLinks", "defectLinks", "automatesLinks", "updated", "votes", "systemFeature", "labels", "epic", "description", "Story Points", "Sprint Name", "jiraSummary", "fixVersions", "Agile Commit", "duedate", "targetRlsGx", "Acceptance Criteria", "Agile Team", "Phase Bug Found", "Phase Bug Introduced", "Failure Category", "Failure Subcategory", "Improvement Suggestions", "Root Cause or Defect Category", "Resolution", "Resolution Details"\n\n',
            dsDescription: null,
            widths: {},
            fixedHeight: null,
            setViewStatus: '',
