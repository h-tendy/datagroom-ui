...
export const dsConstants = {
    ...
    CONVERT_TO_JIRA_REQUEST: 'CONVERT_TO_JIRA_REQUEST',
    CONVERT_TO_JIRA_SUCCESS: 'CONVERT_TO_JIRA_SUCCESS',
    CONVERT_TO_JIRA_FAILURE: 'CONVERT_TO_JIRA_FAILURE',
    CONVERT_TO_JIRA_TRACKER_DELETE: 'CONVERT_TO_JIRA_TRACKER_DELETE'
